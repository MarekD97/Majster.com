...
<body>
    <div class="main-section">
        ...
        <div class="container">
            <div class="row no-gutters row-container" id="desktop">
                <div class="col-sm-9">
                    <h2>Gra interaktywna</h2>
                    <h5>Ułóż wyraz związany z remontem/budową z rozsypanych liter.
                </div>
                
                <div class="col-sm-3">
                    <input type="button" class="button" value="Resetuj" onclick="window.location.reload()" />
                </div>
            ...
            <div class="row no-gutters row-container" id="mobile">
                <h2>Gra nieobsługiwana przez urządzenie mobilne.</h2>
            </div>
        </div>
