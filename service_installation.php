...
<body>
    <div class="main-section">
        ...
        <div class="container" id="content">
            <div>
                <h2>Instalacje</h2>
                <p>Kliknij na animację, aby ją zatrzymać lub odtworzyć ponownie. Ten stan zostanie zapamiętany, jeśli twoja przeglądarka wspiera WebStorage.</p>
                <canvas width="400" height="400" id="animationCanvas" onclick="startStopAnimation()">
